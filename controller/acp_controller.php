...
/**
 * PHPBB XI Server Integration ACP controller.
 */
class acp_controller
{
	...
	public function display_options()
	{
		...
		add_form_key('madetoraid_lsbbb_acp');
		...
		if ($this->request->is_set_post('submit'))
		{
			...
			if (empty($errors))
			{
				...
				trigger_error($this->language->lang('ACP_LSBBB_SETTING_SAVED') . adm_back_link($this->u_action));
			}
		}
